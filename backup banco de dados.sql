...
-- Copiando dados para a tabela pichoflix.filmes: ~1 rows (aproximadamente)
INSERT INTO `filmes` (`idfilmes`, `titulo`, `descricao`, `classificacao`) VALUES
	(1, 'Gothan', 'Filme do Batman', 'Ação');
